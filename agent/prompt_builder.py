...
def _parse_skill_file(skill_file: Path) -> tuple[bool, dict, str]:
    ...
    try:
        ...
        # a runtime environment that isn't active (e.g. s6-only skills outside
        # the container). Explicit loads (skill_view / --skills) bypass this —
        # see skill_matches_environment.
